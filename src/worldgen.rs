                ...
                "block" => {
                    ...
                    let tile = Tile {
                        shape: match *args.get("shape").unwrap_or(&"flat") {
                            ...
                            "l" => {
                                Shape::Left(args.get("height").unwrap().parse().unwrap(),
                                            args.get("heightb").unwrap().parse().unwrap())
                            }
                            "r" => {
                                Shape::Right(args.get("height").unwrap().parse().unwrap(),
                                             args.get("heightb").unwrap().parse().unwrap())
                            }
                            "u" => {
                                Shape::Up(args.get("height").unwrap().parse().unwrap(),
                                          args.get("heightb").unwrap().parse().unwrap())
                            }
                            "d" => {
                                Shape::Down(args.get("height").unwrap().parse().unwrap(),
                                            args.get("heightb").unwrap().parse().unwrap())
                            }
                            "lu" => {
                                Shape::LeftUp(args.get("height").unwrap().parse().unwrap(),
                                              args.get("heightb").unwrap().parse().unwrap())
                            }
